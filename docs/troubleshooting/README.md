...
| **10** | **Argo CD Sync Waves & CRD Races** | `the server could not find the requested resource (post nodepools.karpenter.sh)`; CRD dry-run errors during bootstrap. | [10-argocd-sync-waves-and-crd-race-conditions.md](10-argocd-sync-waves-and-crd-race-conditions.md) |
